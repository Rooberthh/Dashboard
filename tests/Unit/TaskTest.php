<?php
    ...
    class TaskTest extends TestCase
    {
        ...
        function it_is_fetched_in_order()
        {
            ...
            $first = create('App\Models\Task', ['status_id' => $status->id, 'order' => 10, 'updated_at' => Carbon::now()]);
            $second = create('App\Models\Task', ['status_id' => $status->id, 'order' => 10, 'updated_at' => Carbon::now()->subHour()]);
            create('App\Models\Task', ['status_id' => $status->id, 'order' => 10, 'updated_at' => Carbon::now()->subMonth()]);
